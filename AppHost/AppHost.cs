...
builder
    .AddProject<Projects.UploadService_Api>("uploadservice")
    .WaitFor(storage)
...
builder
    .AddProject<Projects.ProcessingService_Worker>("processingservice")
...
builder
    .AddProject<Projects.SearchService_Api>("searchservice")
    .WaitFor(imageMetadataDb)
    .WithEnvironment("Repository__ConnectionString", imageMetadataDb);
